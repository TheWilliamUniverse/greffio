-- Remise à zéro des déclarations non-condamnation (template PDF v7 officiel + stockage S3).
-- Conserve les champs formulaire pour regénération immédiate côté client.
...
SET
  ...
  metadata_json = CASE
    ...
    THEN jsonb_build_object(
      ...
      'editorSchemaVersion', 'manager_non_conviction_v7',
      'resetAt', to_char(NOW() AT TIME ZONE 'UTC', 'YYYY-MM-DD"T"HH24:MI:SS"Z"'),
      'resetReason', 'pdf_template_v7_official_s3'
    )::text
