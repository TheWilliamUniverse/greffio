...
const INTENTS = [
  { id: 'documents', label: 'Documents et pièces', patterns: ['document', 'piece', 'justificatif', 'manque', 'manquant', 'fournir', 'upload', 'deposer'] },
  { id: 'dossier_status', label: 'Statut du dossier', patterns: ['statut', 'avancement', 'ou en suis', 'progression', 'dossier'] },
  { id: 'next_steps', label: 'Prochaines étapes', patterns: ['prochaine', 'etape', 'suite', 'faire maintenant', 'comment avancer'] },
  { id: 'legal_form', label: 'Forme juridique', patterns: ['sas', 'sarl', 'sasu', 'sci', 'ei', 'micro', 'forme'] },
  { id: 'statutes', label: 'Statuts', patterns: ['statut', 'articles', 'generer statut'] },
  { id: 'signature', label: 'Signature', patterns: ['signer', 'signature', 'signe'] },
  { id: 'pricing', label: 'Tarifs et frais', patterns: ['frais', 'tarif', 'prix', 'cout', 'budget', 'payer'] },
