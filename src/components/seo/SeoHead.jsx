...
export const HOME_JSON_LD = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      name: 'Greffio',
      serviceType: 'Accompagnement aux démarches administratives d\'entreprise',
      areaServed: { '@type': 'Country', name: 'France' },
      provider: { '@id': 'https://greffio.willentreprises.com/#organization' },
      description: 'Greffio aide les entrepreneurs français à comprendre, préparer et suivre leurs démarches d\'entreprise.',
    },
  ],
};
