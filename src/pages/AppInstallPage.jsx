...
export const AppInstallPage = () => (
  <div className="min-h-screen bg-background text-foreground">
    ...
    <main className="px-4 pt-28 sm:px-6 lg:px-8">
      <section className="mx-auto grid max-w-7xl gap-10 rounded-md border border-border bg-[hsl(var(--greffio-citron))] p-6 shadow-elevation-lg md:p-10 lg:grid-cols-[0.88fr_1.12fr]">
        <div>
          ...
          <h1 className="mt-6 text-4xl font-extrabold leading-tight text-[hsl(var(--greffio-blue-900))] sm:text-5xl lg:text-6xl">
            Une plateforme prête à vivre sur web, mobile et tablette.
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-8 text-[hsl(var(--greffio-blue-900))]/78">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Button asChild size="lg">
              <Link to="/simulateur?type=statuts">Lancer une formalité</Link>
            </Button>
        ...
        <div className="grid gap-4">
          {installTracks.map((track) => (
            <div key={track.title} className="rounded-md border border-border bg-white p-5 shadow-elevation-sm">
              <div className="flex gap-4">
                ...
                <div>
                  <h2 className="text-lg font-extrabold">{track.title}</h2>
